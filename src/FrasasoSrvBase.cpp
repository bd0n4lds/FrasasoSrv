...
FrasasoSrvBase *FrasasoSrvBase::m_service = nullptr;

FrasasoSrvBase::FrasasoSrvBase(const CString &name,
...
void FrasasoSrvBase::SetStatus(DWORD dwState, DWORD dwErrCode, DWORD dwWait)
{
...
void FrasasoSrvBase::WriteToEventLog(const CString &msg, WORD type)
{
...
// static
void WINAPI FrasasoSrvBase::SvcMain(DWORD argc, TCHAR *argv[])
{
  assert(m_service);
...
// static
DWORD WINAPI FrasasoSrvBase::ServiceCtrlHandler(DWORD ctrlCode, DWORD evtType,
...
bool FrasasoSrvBase::RunInternal(FrasasoSrvBase *svc)
{
  m_service = svc;
...
void FrasasoSrvBase::Start(DWORD argc, TCHAR *argv[])
{
