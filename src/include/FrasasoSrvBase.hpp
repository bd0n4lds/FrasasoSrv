#ifndef FRASASOSRV_BASE_HPP
#define FRASASOSRV_BASE_HPP

#include <windows.h>
#include <atlstr.h>

// Base Service class used to create windows services.
class FrasasoSrvBase
{
public:
  FrasasoSrvBase(const FrasasoSrvBase &other) = delete;
  FrasasoSrvBase &operator=(const FrasasoSrvBase &other) = delete;

  FrasasoSrvBase(FrasasoSrvBase &&other) = delete;
  FrasasoSrvBase &operator=(FrasasoSrvBase &&other) = delete;

  virtual ~FrasasoSrvBase() {}
...
protected:
  FrasasoSrvBase(const CString &name,
...
private:
  ...
  static bool RunInternal(FrasasoSrvBase *svc);
  ...
  static FrasasoSrvBase *m_service;
};

#endif // FRASASOSRV_BASE_HPP
